...
<!--
	Procedure Sequence:
	3) Send Date: One-Step Procedure
...
<?php include 'templates/_inc_procmenu.php'; ?>
		<div style="margin-top: 25px;">
			<?php echo lang_one_step_instructions; ?>
		</div>
		<hr />
		<div>
...
<?php echo $selRecurPeriod; ?>
				...
				<div style='float: right;'>
					<input type='button' onclick='location.href="/ponestep";' value='<?php echo lang_undo_changes; ?>' title='<?php echo lang_reload_page; ?>' />
					<input type='button' onclick='location.href="/procedures/back/3)seltype";'  value='&lt;&lt; <?php echo lang_back; ?>' title='<?php echo lang_back_previous_step; ?>: <?php echo lang_select_proc_type; ?>' />
					<input type='submit' id='btnProceed' value='<?php echo lang_proceed; ?> &gt;&gt;' title='<?php echo lang_proceed_next_step; ?>: <?php echo lang_unless_crit_b; ?>' />
				</div>
				<div class='clearBoth'>&nbsp;</div>
			</form>
		</div>
		<div style="margin-top: 25px;">
			<?php echo lang_one_step_note; ?>
		</div>
